...
path_JAM<-'/net/bliss-04-nfs/projects/cardioprj/Experiments/FINE-MAPPING-FEB-21/JAM-FLASHFM/'
...
main.input <- JAMexpanded.multi(betas,X,snpinfo,ybar,Vy,N=Ne,chr=k,fstub=fstub,mafthr=0,
                                path2plink="/net/bliss-04-nfs/scratch/jennifer/software/plink",r2=0.9,
...
if (reg.indicator[reg,8]==4 | reg.indicator[reg,8]==5){
  fm.multi <- flashfm(main.input, TOdds=1,covY=covY,ss.stats=ss.stats,cpp=0.95,maxmod=NULL,fastapprox=FALSE, NCORES=M)
} else {
